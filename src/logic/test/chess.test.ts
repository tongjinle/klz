...
describe("chess list", () => {
  ...
  // it("knight", () => {
  //   let me: Chess = Chess.createChessByType(ChessType.knight);
  //   me.posi = { x: 4, y: 4 };
  //   let sk = me.skillList[0];
  //   chBoard.addChess(me);

  //   let ch1: Chess = new Chess();
  //   ch1.posi = { x: 1, y: 5 };
  //   let ch2: Chess = new Chess();
  //   ch2.posi = { x: 1, y: 3 };
  //   ch1.hp = ch2.hp = 100;
  ...
  //   let heal = _.find(me.skillList, sk => sk.type == SkillType.heal);
  //   expect(toStr(heal.getCastRange())).toEqual(
  //     toStr([{ x: 3, y: 4 }, { x: 4, y: 4 }])
  //   );
  // });
  ...
  //   expect(toStr(purge.getCastRange())).toEqual(
  //     toStr([{ x: 1, y: 4 }, { x: 0, y: 4 }])
  //   );
  ...
  //   let toStr = range => range.map(po => [po.x, po.y].join("-")).sort();
  //   expect(toStr(me.getMoveRange())).toEqual(
  //     toStr([
  //       // {x:1,y:3},
  //       { x: 1, y: 4 },
  //       { x: 1, y: 5 },
